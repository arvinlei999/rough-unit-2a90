...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "nameless-night-26f9-d1":

```bash
npx wrangler d1 create nameless-night-26f9-d1
```
